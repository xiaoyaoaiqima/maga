Create Codex pet row `running-left` for `nai-long`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 界面显示名使用奶龙。以参考图中的黄色圆润小龙为唯一角色原型：大圆脑袋，短粗四肢，奶白色椭圆肚皮，绿色大眼睛，开心张嘴笑，头顶无角，背部无翅膀，手脚末端有棕色小爪；保留软萌3D玩具质感与憨厚亲近感。. Preserve silhouette, face, palette, material, proportions, markings, and props.
