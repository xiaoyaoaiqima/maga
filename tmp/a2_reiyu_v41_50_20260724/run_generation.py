...
SOURCE_ROWS = set(range(1, 17))
COUNT = 50
OUTPUT_DIR = Path("/Users/luxifa/maga/outputs/a2_reiyu_v41_50_20260724")
MODEL_CONFIG = {
    ...
    try:
        async with async_session_factory() as db:
            ...
            job = await ContentBatchPlanner(db)._create_article_business_rule_plan(
                ...
                created_by="codex_a2_reiyu_v41_can_50",
            )
            batch_id = job.id
            await db.commit()
