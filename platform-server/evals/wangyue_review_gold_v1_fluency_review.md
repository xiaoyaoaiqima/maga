...
## 2026-07-17 补充：中英文混写代词

### WYL-020｜block

> 看ta最近长个儿明显，吃饭也比以前积极，就感觉选对了。

中文正文中用独立 `ta/Ta/TA` 指代孩子或人物，属于确定性流畅性问题。代码硬审直接命中 `malformed_fragment`，局部改写为“他”“她”或“孩子”；如果改写后仍残留，不允许保持 `hard_pass=true`。该边界不扩大到普通英文单词，也不改变“长个儿明显、吃饭积极”等效果表达的现有口径。
