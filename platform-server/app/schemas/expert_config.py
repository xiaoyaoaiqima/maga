...
class ExpertConfigBase(BaseSchema):
    ...
    expert_app: str = Field(..., max_length=255, description="expert的app（Dapr app ID，如 raap-service-ag）")
    expert_service: str = Field(..., max_length=255, description="expert的service名称，如 critic.CriticService")
